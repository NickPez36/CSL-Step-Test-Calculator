            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.zonesTable}>
                    ...
                    <View style={[styles.zoneRow, { backgroundColor: '#84cc16' }]}>
                        <Text style={[styles.zoneCell, styles.zoneDomain]}>MODERATE</Text>
                    ...
                    <View style={[styles.zoneRow, { backgroundColor: '#a3e635' }]}>
                        <Text style={[styles.zoneCell, styles.zoneDomain]}></Text>
                    ...
                    <View style={[styles.zoneRow, { backgroundColor: '#facc15' }]}>
                        <Text style={[styles.zoneCell, styles.zoneDomain]}>HEAVY</Text>
                    ...
                    <View style={[styles.zoneRow, { backgroundColor: '#ea580c' }]}>
                        <Text style={[styles.zoneCell, styles.zoneDomain, { color: '#fff' }]}>SEVERE</Text>
                    ...
                    <View style={[styles.zoneRow, { backgroundColor: '#dc2626' }]}>
                        <Text style={[styles.zoneCell, styles.zoneDomain, { color: '#fff' }]}>EXTREME</Text>
                        ...
                        {result.efficiencyData.map((item) => {
                            ...
                            return (
                                <View key={item.step} style={styles.tableRow}>
                                    ...
                                    <Text style={[styles.tableCell, { width: 80, color: percentChange > 0 ? '#059669' : percentChange < 0 ? '#dc2626' : '#111827' }]}>
                                        {percentChange >= 0 ? '+' : ''}{displayChange}%
                                    </Text>
                                    <Text style={[styles.tableCell, { flex: 1 }]}>
                                        {percentChange >= 0 ? '▓'.repeat(Math.min(20, Math.abs(Math.round(percentChange)))) : '░'.repeat(Math.min(20, Math.abs(Math.round(percentChange))))}
                                    </Text>
                                </View>
                            );
                        })}
